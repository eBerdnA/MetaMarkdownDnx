...
namespace BeAnSys.MetaMarkdownDnx
{
    ...
    public class Markdown
    {
        ...
        public Markdown(bool loadOptionsFromConfigFile)
        {
            ...
            // new way of config with dnx
            var builder = new ConfigurationBuilder()
                .AddJsonFile("metamarkdownsettings.json");
            ...
            foreach (var child in children)
            {
                switch (child.Key)
                {
                    case "Markdown.AutoHyperlink":
                        _autoHyperlink = Convert.ToBoolean(child.Value);
                        break;
                    case "Markdown.AutoNewlines":
                        _autoNewlines = Convert.ToBoolean(child.Value);
                        break;
                    case "Markdown.EmptyElementSuffix":
                        _emptyElementSuffix = child.Value;
                        break;
                    case "Markdown.LinkEmails":
                        _linkEmails = Convert.ToBoolean(child.Value);
                        break;
                    case "Markdown.StrictBoldItalic":
                        _strictBoldItalic = Convert.ToBoolean(child.Value);
                        break;
                    case "Markdown.AsteriskIntraWordEmphasis":
                        _asteriskIntraWordEmphasis = Convert.ToBoolean(child.Value);
                        break;
                }
            }
        }
